...
if order == "ice coffee" or order == "4":
    price = 20

elif order == "espresso" or order == "3":
    price = 13

elif order == "black coffee" or order == "1":
    price = 9

elif order == "latte" or order == "2":  # Changed 'if' to 'elif' to avoid premature exit
